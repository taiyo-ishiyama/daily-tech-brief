...
const TOPICS = [
  ...
  },
  {
    ...
    description:
      "Languages, tooling, and engineering practices shaping how software is built. From backend systems to developer experience.",
  },
  {
    _id: "topic-career",
    _type: "topic",
    ...
    description:
      "Career growth, productivity, and the evolving landscape of working in tech. Practical insights for engineers and makers.",
  },
];
